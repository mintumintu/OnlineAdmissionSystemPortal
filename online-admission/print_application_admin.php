...
?>
      ...
      <td colspan="3">&emsp;<a class="thumb" href="#"><img src="images/imgicon.png" alt=""/><span><img src="data:image/png;base64,<?=base64_encode(file_get_contents('./pg/ulasset/'.$admin->getAppAttachmentDetails($user_id, 9))) ?>" alt=""/></span></a></i></td>
	  </tr>
	  <?php
