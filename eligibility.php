<?php 
include_once "online-admission/config.php";
                	...
                	<div class="col1">			
                         ...
                         <!-- Content Heading -->
                         	...
                         	<div class="content_heading">
                            	...
                            	<div class="heading"><h2 style="font-size:15px;font-weight:bold;">Students <span style="color:#888;">Eligibility : </span></h2> </div>
    ...
    <td class="bg_table">
		...
		<table width="450" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <tr>
			...
			<td class="tbl_head">Subject</td>

			<td class="tbl_head">Intake Capacity</td>

		  </tr>

		  <tr>

			<td class="odd">Bengali Hons.</td>
		  ...
		  <tr>
			...
			<td class="even">Geography Hons.</td>
